...
#define TCOL col, col + 1
	...
	TriggerBox::CueRecordingChanged.connect (forever_connections, MISSING_INVALIDATOR, boost::bind (&TransportBar::cue_rec_state_changed, this), gui_context ());
...
bool
TransportBar::bind_lua_action_script (GdkEventButton*ev, int i)
{
	if (!_session) {
		return false;
	}
...
void
TransportBar::action_script_changed (int i, const std::string& n)
{
