	...
	*/
	Gtk::VBox         _content_vbox;               /* this is the root widget for a full-featured tabbable, which contains:  */
		Gtk::HBox           _content_header_hbox;
			Gtk::HBox           _content_transport_hbox;
				Gtk::EventBox       _content_transport_ebox;         /* a placeholder for the transport bar, if you want one */
				...
				Gtk::EventBox       _content_tabbables_ebox;         /* a placeholder for the tabbable switching buttons (used by ArdourUI) */
